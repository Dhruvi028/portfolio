export const resume = {
    ...
    skills: {
        "Frontend & Programming": [
            ...
            "HTML5", "CSS3", "Tailwind CSS", "Redux Toolkit", "ShadCN UI"
        ],
        "Backend & Frameworks": [
            "Python", "Node.js", "FastAPI", "Django", "Laravel", "NestJS", 
            "Express.js", "REST APIs", "WebSockets", "GraphQL"
        ],
        "Authentication & Security": [
            "JWT Authentication", "Role-Based Access Control (RBAC)", "Auth0", 
            "SSO", "Secure API Design", "Payment Gateway Integration (Stripe)"
        ],
        "Databases & Storage": [
            "PostgreSQL", "MongoDB", "MySQL", "PocketBase", "Firebase"
        ],
        "Cloud & Deployment": [
            "AWS Amplify", "DigitalOcean", "Fly.io", "Vercel", "Docker"
        ],
        "Tools & DevOps": [
            "Git", "Jenkins", "Swagger", "Selenium", "Chart.js", "WebSockets", "CI/CD Pipelines"
        ],
        "Collaboration": [
            "Agile / Scrum", "Technical Documentation", "Team Leadership", "Stakeholder Communication"
        ]
    },
    experience: [
        {
        ...
        },
        {
            ...
            description: [
                "Developed and maintained web applications using front-end and back-end technologies, writing clean, efficient, and scalable code.",
    ...
    projects: [
        {
            title: "Automation and Web Development Projects",
    ...
    education: [
        {
            degree: "BACHELOR'S OF ENGINEERING IN IT",
