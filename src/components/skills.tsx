            ...
            <div className="container px-6">
                ...
                <div ref={ref} className="max-w-6xl mx-auto space-y-10">
                    {Object.entries(resume.skills).map(([category, skillList], categoryIndex) => {
                        const filteredSkills = (skillList as string[]).filter(s => resume.highlightedSkills?.includes(s));
                        if (filteredSkills.length === 0 && resume.highlightedSkills && resume.highlightedSkills.length > 0) return null;
                        
                        const displaySkills = resume.highlightedSkills && resume.highlightedSkills.length > 0 ? filteredSkills : skillList;
