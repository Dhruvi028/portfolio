...
export function MiloPortfolio({
        ...
        ? {
            ...
            content: (
              <div className="flex flex-col h-full justify-center space-y-6">
                ...
                <h2 className="text-lg sm:text-xl text-white/70 font-light">
                  {personalInfo.role} based in {personalInfo.contact.location}
                </h2>
                <p className="text-base leading-relaxed text-white/80 mt-6 max-w-2xl">
                  {personalInfo.about}
                </p>
                <div className="pt-8">
                  <a
  ...
  return (
    <main className="absolute inset-0 bg-[#000000] text-white font-mono overflow-hidden">
      {/* BACKGROUND GRID */}
      <div
      ...
      <DraggableSticker
        className="top-[2%] right-[2%] md:right-[10%] md:top-[8%] z-40"
        rotate={-5}
      >
      ...
      {/* CENTRAL CARD STACK */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-30 p-4 sm:p-8 pt-16 sm:pt-12">
        <div className="relative w-full max-w-3xl h-[85%] max-h-[750px] pointer-events-auto">
